...
window.TomatoState.createPlayer = ({ type, chars, width, height, createWeapon }) => {
  ...
  return {
    ...
    projectileSpeed:1,crit:type==='cherry'?.12:0,critDamage:0,regen:type==='green'?.6:0,regenClock:0,poisonClock:0,
    ...
    seedBonus:type==='golden'?.4:0,trait,healEvery:5,weapons:[createWeapon(starter)]
  };
};
